...
def synonym_replacement(words, sdp_wrods, n):
    new_words = words.copy()
    random_word_list = list(set([word for word in words if word not in stop_words + sdp_wrods]))
...
def swap_word(new_words, sdp_word_idx):
    ...
    counter = 0
    while random_idx_2 == random_idx_1 or random_idx_1 in sdp_word_idx or random_idx_2 in sdp_word_idx:
